...
2. **Choose your entry role:**  
   - [`agents/OPERATOR.md`](agents/OPERATOR.md) — runbook for day-to-day operation  
   - [`agents/AUDITOR.md`](agents/AUDITOR.md) — detect missing governance before it cascades  
   - [`agents/INSTALLER.md`](agents/INSTALLER.md) — replicate Wingman into another repo/system  
...
- transactional outbox patterns …and other governance-preserving deployment shapes.
...
- [`OPERATOR.md`](agents/OPERATOR.md)  
- [`INSTALLER.md`](agents/INSTALLER.md)  
- [`AUDITOR.md`](agents/AUDITOR.md)  
- [`LEGAL.md`](agents/LEGAL.md)  
- [`FINANCE.md`](agents/FINANCE.md)  
- [`SCHEDULER.md`](agents/SCHEDULER.md)  
- [`WRITER.md`](agents/WRITER.md)  
- [`DEMO.md`](agents/DEMO.md)  
- [`SPORE.md`](agents/SPORE.md) (seed replication / propagation role)  
...
See: [`agent_templates/README.md`](agent_templates/README.md)
...
1. Read: [`training/QUICKSTART.md`](training/QUICKSTART.md)  
