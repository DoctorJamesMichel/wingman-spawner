...
- `training/CHECKLIST_PRE_RUN.md`
- `training/CHECKLIST_MID_RUN.md`
- `training/CHECKLIST_POST_RUN.md`
- `training/FAILURE_MODES.md`
- `training/CERTIFICATION_LOOP.md`
...
scope, permissions, audit requirements, rollback behavior, and consent rules.
...
- `primitives/P-07_CONSENTFUL_TRAINING.md`
...
Root documentation was updated to reflect current repo structure:
...
- v0.2 is now marked **IN PROGRESS**
...
- You should treat `/training/` as mandatory reading before real execution.
- You should use `/agent_templates/` when cloning or spawning new agents.
...
- `/patterns/` established as deployable architectures
- `/agents/` established as reusable role contracts
